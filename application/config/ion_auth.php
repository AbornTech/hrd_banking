...
//$config['collections']['login_attempts'] = 'admin_login_attempts';
 ...
 */
$config['site_title']                 = "doctodocs.com";       // Site Title, example.com
$config['admin_email']                = "admin@doctodocs.com"; // Admin Email, admin@example.com
$config['default_group']              = 'admin';           // Default group, use name
$config['groups']                		= 'admin';             // Default administrators group, use name
...
$config['email_config'] = array(
	'mailtype' => 'html',
    'protocol' => 'smtp',
    'smtp_host' => 'webmail.ilmp-tech.com',
    'smtp_user' => 'sanket.khanna@ilmp-tech.com', // actual values different
    'smtp_pass' => 'ilmp123it',
    'smtp_port' => '25'
);
